        ...
        <div>
          ...
          <div className="main-body" data-testid = "home">
            <Routes>
              ...
              <Route path="/leaderboard" exact  element={<Private><LeaderBoard /></Private>} />
              <Route path="/login" exact element={<Login />}/>
              <Route path="/new" exact element={<Private><New /></Private>} />
              <Route path="/questions/:id" element={<Private><DetailWrapper  /></Private>} />
              {/* <Route element={<Main />} /> */}
